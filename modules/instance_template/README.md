...
| <a name="input_additional_networks"></a> [additional\_networks](#input\_additional\_networks) | Additional network interface details for GCE, if any. | <pre>list(object({<br>    network            = string<br>    subnetwork         = string<br>    subnetwork_project = string<br>    network_ip         = string<br>    # Ignore next 3 objects until we upgrade TF and can use optional attributes<br>    # access_config = list(object({<br>    #   nat_ip       = string<br>    #   network_tier = string<br>    # }))<br>    # ipv6_access_config = list(object({<br>    #   network_tier = string<br>    # }))<br>    # alias_ip_range = list(object({<br>    #   ip_cidr_range         = string<br>    #   subnetwork_range_name = string<br>    # }))<br>  }))</pre> | `[]` | no |
